...
export default function OrderTimeline({ transactions, walletMap, orderId, onRefresh }) {
  ...
  async function approveTx(tx) {
    try {
      ...
      const newStatus =
        nextStage >= chain.length ? "pending_final_approval" : "in_transit";
            ...
            <div key={tx.id} className="flex gap-4">
              ...
              <div className="flex flex-col items-center">
                ...
                >
                  ...
                  {!["completed", "pending_approval", "rejected"].includes(tx.status) && (
              ...
              <div className="flex-1 pb-4">
                ...
                <div className="mt-2 text-sm">
                  ...
                  <span className="ml-3 font-mono font-semibold">
